...
2.  **Determinación del Número Óptimo de Clusters (K):** Se utilizó el método del **Codo (*Elbow Method*)** y/o el **Coeficiente de Silueta (*Silhouette Score*)** para determinar el valor óptimo de $K=5$.
